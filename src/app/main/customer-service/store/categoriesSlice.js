...
export const getCategories = createAsyncThunk(
  'customerServicesApp/categories/getCategories',
  async () => {
...
export const { selectAll: selectCategories, selectById: selectCategoryById } =
  categoriesAdapter.getSelectors((state) => state.customerServicesApp.categories);

const categorySlice = createSlice({
  name: 'customerServicesApp/categories',
